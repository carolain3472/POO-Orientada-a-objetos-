...
/**
  Utilidad para la asignatura: vamos a crear una nueva clase, CuentaBancaria, para eliminar el pair<string, int> del Banco. De este modo, necesitaremos usar punteros para implementar la relación "conoce". Concretamente, cada Persona conoce su CuentaBancaria y el Banco conoce todas las CuentasBancarias. 
...
{  
  ...
  unBanco.recibirPlata(ana.dimeTuNombre(), ana.daTodaLaPlata());
